...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_IMAGEGEN_ALLOW_OVERSUBSCRIBE": {"OLLAMA_IMAGEGEN_ALLOW_OVERSUBSCRIBE", Var("OLLAMA_IMAGEGEN_ALLOW_OVERSUBSCRIBE"), "Allow image generation models to load when required memory slightly exceeds available memory (at your own risk)"},
